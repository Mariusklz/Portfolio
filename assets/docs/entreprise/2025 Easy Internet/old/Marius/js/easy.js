...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const BarreRecherche = document.getElementById("recherche-container"); // Bouton Recherche
    ...
    function afficherSection(section) {
        ...
        if (section === "Accueil") {
            ...
            if (contentRecherche) {
                ...
                contentRecherche.style.backgroundColor = "white";
            } else {
            ...
            if (contentRecherche) {
                // Ajouter cette ligne pour mettre 'content-Recherche' en rouge si l'élément existe
                contentRecherche.style.backgroundColor = "#E7AE9E";
            } else {
                console.error("Erreur : L'élément avec la classe 'content-Recherche' n'a pas été trouvé !");
            }
